 ...
 * @author Usuario
 */
public class FrameCuad extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCuad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

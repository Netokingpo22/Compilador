...
public class CompyN extends javax.swing.JFrame {
...
//Leemos el archivo
    ...
    private void initComponents() {
        ...
        btnUltima.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnExcel2.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnCadruplo.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelActionPerformed
        try {
            ...
            Logger.getLogger(CompyN.class.getName()).log(Level.SEVERE, null, ex);
        }
